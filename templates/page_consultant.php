...
<div>
    ...
    <form id="astro-contactform" class="uk-grid-small" uk-grid>
        ...
        <div class="uk-width-1-1@m">
            <textarea class="uk-textarea" rows="5" name="client-message" placeholder="Укажите дату, время и место рождения" required></textarea>
        </div>
        <input type="hidden" value="Заявка на консультацию" name="subject">
        <div class="uk-width-1-1@m">
